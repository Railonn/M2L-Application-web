                        ...
                        <tbody>
                           <tr>
                              ...
                              <td class="text-right"><a href="index.php?uc=gestionDemandeur&date=<?=$date?>&motif=<?=$motif?>&action=voirModifierDemande"> 
                                 <img src="https://img.icons8.com/color/48/000000/edit.png" style="width:30px; height:30px;" title="Modifier lade demande de frais"></a>
                              </td>
                              <td><a href="index.php?uc=gestionDemandeur&date=<?=$date?>&action=supprimerDemande"> 
                                 <img src="https://img.icons8.com/color/48/000000/close-window.png" style="width:30px; height:30px;" title="Supprimer la demdande de frais" onclick="return confirm('Voulez-vous vraiment supprimer cette demande de frais ?');"></a>
                              </td>
                              <?php
                                 $i = $i + 1;
                                 }
