            ...
            <div class="card text-white bg-dark col-sm-6 col-md-8 ">
               <div class="card-body text-white">
                  <div class="card-header">
                     <h4 class="mb-3"> Bienvenue sur l'application de la Maison des Ligues de Lorraine ! </h4>
                  </div>
                  <div class="container mt-3">
                     ...
                     <div class="alert alert-danger" role="alert">
                        Vous n'avez pas encore effectué de demandes !
                        <hr>
                        <a href="index.php?uc=gestionDemandeur&action=voirDemandeFrais">Consulter la page des demandes de remboursement</a>
                     </div>
                     <?php
                        }
                     ...
                     <div class="alert alert-warning" role="alert">
                        Vous avez effectué <?php echo $nbDemandesFrais; ?> demandes de remboursement.<br> Aucune des demandes n'ont été validées.
                        <hr>
                        <a href="index.php?uc=gestionDemandeur&action=voirConsulterDemandeFrais">Consultez vos demandes de remboursement</a>
                     </div>
                     <?php
                        }
                        else if(($nbDemandesFrais > 0)  && ($nbDemandesFraisValid > 0))
                     ...
                     <div class="alert alert-success" role="alert">
                        Vous avez effectué <?php echo $nbDemandesFrais; ?> demandes de remboursement.<br> <?php echo $nbDemandesFraisValid; ?> demandes de remboursement à été validée.
                        <hr>
                        <a href="index.php?uc=gestionDemandeur&action=voirConsulterDemandeFrais">Consultez vos demandes de remboursement</a>
                     </div>
                     <?php
